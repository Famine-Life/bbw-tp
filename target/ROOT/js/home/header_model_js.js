...
//                根据滚动的距离分别修改透明度
    ...
    // $(".login_or_register_string").mouseover()(function () {
    //     $('.personal_nav').show(0).animate({height: '31%'}, 500);
    // });
    $('.user_name_a').mouseover(function () {
        $('.personal_nav').show(0).animate({height: 'auto'}, 500);
    });

    $('.user_name_a').mouseout(function () {
        $('.personal_nav').hide(0);
    });
    $('.personal_nav').mouseover(function () {
        $('.personal_nav').show(0);
         // $('.personal_nav').show(0).animate({height: '31%'}, 500);
    });
    $('.personal_nav').mouseout(function () {
        $('.personal_nav').hide(0);
       //  if ($('.personal_nav').is(":visible")) {
